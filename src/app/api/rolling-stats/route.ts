...
export async function GET(request: NextRequest) {
  try {
    ...
    // Create parameter-based cache key. Include the computation script so model
    // logic changes cannot reuse stale outputs generated by older code.
    const cacheKey = crypto.createHash('md5')
      .update(JSON.stringify(params))
      .update(dataset.id)
      .update(await fs.readFile(dataPath, 'utf8'))
      .update(await fs.readFile(scriptPath, 'utf8'))
      .digest('hex');
